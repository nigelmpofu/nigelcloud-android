...
public class AccountUtils {
    ...
    /**
     * Returns nigelcloud account identified by accountName or null if it does not exist.
     * @param context
     * @param accountName name of account to be returned
     * @return nigelcloud account named accountName
     */
        ...
        if ( currentAccount != null ) {
            ...
            if (currentAccountVersion == null) {
                ...
                for (Account account : ocAccounts) {
                    ...
                    username = com.nigelcloud.android.lib.common.accounts.AccountUtils.
                            getUsernameForAccount(account);
                    newAccountName = com.nigelcloud.android.lib.common.accounts.AccountUtils.
