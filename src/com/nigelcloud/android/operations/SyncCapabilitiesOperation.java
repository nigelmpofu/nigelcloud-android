...
import com.nigelcloud.android.lib.resources.status.GetRemoteCapabilitiesOperation;
import com.nigelcloud.android.lib.resources.status.GetRemoteStatusOperation;
...
public class SyncCapabilitiesOperation extends SyncOperation<OCCapability> {
    ...
    protected RemoteOperationResult<OCCapability> run(OwnCloudClient client) {
        ...
        // library: com.nigelcloud.android.lib.common.accounts.AccountUtils#getCredentialsForAccount(...)
        // and com.nigelcloud.android.lib.common.accounts.AccountUtils#getServerVersionForAccount(...)
        if (serverVersion != null) {
            AccountManager accountMngr = AccountManager.get(MainApp.getAppContext());
            accountMngr.setUserData(
                getStorageManager().getAccount(),
                com.nigelcloud.android.lib.common.accounts.AccountUtils.Constants.KEY_OC_VERSION,
